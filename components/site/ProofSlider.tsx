    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden" style={{ clipPath: `inset(0 0 0 ${pos}%)` }}>
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg,#f5ede1 0%,#f1e7d8 68%)" }}>
          ...
          <div className="absolute" style={{ right: "8%", top: "15.4%", width: "34%", height: "39%", borderRadius: 5, background: "linear-gradient(160deg,#dcebf6,#c2d9ec)", border: "8px solid #fff", boxShadow: "0 10px 24px -10px rgba(24,36,33,.25)" }} />
          ...
          <span className="absolute bottom-3.5 right-3.5 inline-flex items-center rounded-lg px-2.5 py-1.5 text-[12px] font-bold tracking-wide text-white" style={{ background: "rgba(29,186,154,.92)" }}>
            AFTER · 06/16
          </span>
        </div>
      </div>
      ...
      {/* handle */}
      <div className="absolute inset-y-0 z-[4]" style={{ left: `${pos}%`, width: 3, background: "rgba(255,255,255,.9)", transform: "translateX(-1.5px)", boxShadow: "0 0 0 1px rgba(24,36,33,.06)" }}>
        <span className="absolute left-1/2 top-1/2 grid h-[46px] w-[46px] -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full text-ink" style={{ background: "linear-gradient(180deg,#fff,#ecf6f2)", boxShadow: "0 6px 16px -4px rgba(24,36,33,.5),inset 0 1px 0 #fff" }}>
