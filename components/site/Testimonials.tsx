      ...
      <div className="mx-auto max-w-[1200px] px-6 sm:px-8">
        <div className="mb-10 flex flex-wrap items-start justify-between gap-7">
          <h2 className="m-0 max-w-[520px] text-[clamp(28px,3.4vw,42px)] font-extrabold leading-[1.06] tracking-[-1.3px] text-white">
            ...
            <span className="font-script text-[1.06em] text-[#2ed3a6]">
              manage units
            </span>
          </h2>
        ...
        <div className="grid gap-7 lg:grid-cols-[280px_1fr]">
          <div
            ...
            style={{ border: "1px solid #16433d" }}
          >
            <PhotoSlot label="Client photo" />
          </div>
          <div
            className="relative rounded-[22px] px-10 py-[38px]"
            style={{ background: "linear-gradient(165deg,#0e2b27,#0e2a26)", border: "1px solid #16433d" }}
          >
            <span className="font-script text-[64px] leading-[.4] text-[#2ed3a6]">
              &ldquo;
            </span>
            <h3 className="mb-3.5 mt-1.5 text-[24px] font-extrabold tracking-[-.6px] text-white">
              Smooth from key handoff to re-list.
            </h3>
            <p className="m-0 max-w-[560px] text-[16px] leading-[1.65] text-[#a9bfb9]">
            ...
            <div className="mt-7 flex flex-wrap items-center justify-between gap-5">
              <div className="flex items-center gap-3.5">
                <span
                  ...
                  style={{ background: "linear-gradient(160deg,#2ed3a6,#0c8466)" }}
                >
                  DM
                </span>
                <div>
              ...
              <Link
                ...
                style={{ background: "linear-gradient(180deg,#fff,#dcebe5)", boxShadow: "inset 0 1px 0 #fff" }}
              >
                Get the same turn
                <span
